...
| 条件 | Top-1正解率 | Recall@10 | ゼロ件率 | 圏外率 |
|---|---|---|---|---|
| ファイル名検索（ベースライン） | 0.333 | 0.553 | 0.167 | 0.400 |
| メタデータ検索（AIタグ絞り込み） | 0.533 | 0.435 | 0.400 | 0.467 |
| 会話型AI検索 | 0.967 | 0.948 | 0.000 | 0.000 |
| AI構造検索 | 0.567 | 0.864 | — | — |

**ゼロ件率**は「検索結果が1件も返らなかった課題の割合」、**圏外率**は「上位10件のどこにも正解が現れなかった課題の割合」です。両者は別の指標で、値も一致しません。
...
| Condition | Top-1 accuracy | Recall@10 | Zero-result rate | Out-of-top-10 rate |
|---|---|---|---|---|
| Filename search (baseline) | 0.333 | 0.553 | 0.167 | 0.400 |
| Metadata search (AI tag filtering) | 0.533 | 0.435 | 0.400 | 0.467 |
| Conversational AI search | 0.967 | 0.948 | 0.000 | 0.000 |
| Structured AI search | 0.567 | 0.864 | — | — |

*Zero-result rate* = share of tasks returning no results at all. *Out-of-top-10 rate* = share of tasks where no correct file appeared in the top 10. These are different measures and their values differ.
